...
ax.text(max_patient * 0.95, mean_dreamy + 0.15, 
        f'○ {mean_dreamy:.2f}', color='#4E79A7', 
        fontsize=11, fontweight='bold', ha='right')
ax.text(max_patient * 0.95, mean_duck + 0.15, 
        f'△ {mean_duck:.2f}', color='#E15759', 
        fontsize=11, fontweight='bold', ha='right')
...
ax.text(max_patient * 0.95, mean_dreamy_rand + 0.15, 
        f'○ {mean_dreamy_rand:.2f}', color='#4E79A7', 
        fontsize=11, fontweight='bold', ha='right')
ax.text(max_patient * 0.95, mean_duck_rand + 0.15, 
        f'△ {mean_duck_rand:.2f}', color='#E15759', 
        fontsize=11, fontweight='bold', ha='right')
...
ax.text(max_severity * 0.9, mean_dreamy_sev + 0.15, 
        f'○ {mean_dreamy_sev:.2f}', color='#4E79A7', 
        fontsize=11, fontweight='bold', ha='right')
ax.text(max_severity * 0.9, mean_duck_sev + 0.15, 
        f'△ {mean_duck_sev:.2f}', color='#E15759', 
        fontsize=11, fontweight='bold', ha='right')
