...
subtitle: "Stratification to Overcome a Common Cause Confounde"
format:
  html: default
...
ax.scatter(dreamy_data['patient'], dreamy_data['post_surgical_score'], 
           c='#4E79A7', marker='o', s=60, alpha=0.7, label='Doc Dreamy')
ax.scatter(duck_data['patient'], duck_data['post_surgical_score'], 
           c='#E15759', marker='^', s=60, alpha=0.7, label='Doc Duck')

# Add horizontal mean lines (dashed)
ax.axhline(y=mean_dreamy, color='#4E79A7', linestyle='--', linewidth=0.8)
ax.axhline(y=mean_duck, color='#E15759', linestyle='--', linewidth=0.8)

# Add text annotations with mean values and shape symbols
max_patient = patients_df['patient'].max()
# Position annotations to avoid overlap - put higher mean above, lower mean below
if mean_dreamy < mean_duck:
    ax.text(max_patient * 0.95, mean_dreamy - 0.2, 
            f'○ Doc Dreamy: {mean_dreamy:.2f}', color='#4E79A7', 
            fontsize=11, fontweight='bold', ha='right', va='top')
    ax.text(max_patient * 0.95, mean_duck + 0.2, 
            f'△ Doc Duck: {mean_duck:.2f}', color='#E15759', 
...
ax.set_xlabel('Patient Number', fontsize=11, fontweight='bold')
ax.set_ylabel('Post-Surgical Symptom Score (Lower is Better)', fontsize=11, fontweight='bold')
...
ax.legend(loc='lower center', bbox_to_anchor=(0.5, -0.15), ncol=2, frameon=True, fontsize=10)
...
print(patients_randomized_df.head())
```
:::
...
# Add horizontal mean lines (dashed)
ax.axhline(y=mean_dreamy_rand, color='#4E79A7', linestyle='--', linewidth=0.8)
ax.axhline(y=mean_duck_rand, color='#E15759', linestyle='--', linewidth=0.8)

# Add text annotations with mean values and shape symbols
max_patient = patients_randomized_df['patient'].max()
# Position annotations to avoid overlap - put higher mean above, lower mean below
if mean_dreamy_rand < mean_duck_rand:
    ax.text(max_patient * 0.95, mean_dreamy_rand - 0.2, 
            f'○ Doc Dreamy: {mean_dreamy_rand:.2f}', color='#4E79A7', 
            fontsize=11, fontweight='bold', ha='right', va='top')
    ax.text(max_patient * 0.95, mean_duck_rand + 0.2, 
            f'△ Doc Duck: {mean_duck_rand:.2f}', color='#E15759', 
            fontsize=11, fontweight='bold', ha='right', va='bottom')
else:
    ax.text(max_patient * 0.95, mean_dreamy_rand + 0.2, 
            f'○ Doc Dreamy: {mean_dreamy_rand:.2f}', color='#4E79A7', 
...
y_min = patients_df['post_surgical_score'].min() - 0.5
y_max = patients_df['post_surgical_score'].max() + 0.5
...
ax.scatter(dreamy_data['severity'], dreamy_data['post_surgical_score'], 
           c='#4E79A7', marker='o', s=60, alpha=0.7, label='Doc Dreamy', zorder=2)
ax.scatter(duck_data['severity'], duck_data['post_surgical_score'], 
           c='#E15759', marker='^', s=60, alpha=0.7, label='Doc Duck', zorder=2)

# Add horizontal mean lines (dashed)
ax.axhline(y=mean_dreamy_sev, color='#4E79A7', linestyle='--', linewidth=0.8, zorder=1)
ax.axhline(y=mean_duck_sev, color='#E15759', linestyle='--', linewidth=0.8, zorder=1)

# Add text annotations with mean values and shape symbols
max_severity = patients_df['severity'].max()
# Position annotations to avoid overlap - put higher mean above, lower mean below
if mean_dreamy_sev < mean_duck_sev:
    ax.text(max_severity * 0.9, mean_dreamy_sev - 0.2, 
            f'○ Doc Dreamy: {mean_dreamy_sev:.2f}', color='#4E79A7', 
            fontsize=11, fontweight='bold', ha='right', va='top')
    ax.text(max_severity * 0.9, mean_duck_sev + 0.2, 
            f'△ Doc Duck: {mean_duck_sev:.2f}', color='#E15759', 
            fontsize=11, fontweight='bold', ha='right', va='bottom')
else:
    ax.text(max_severity * 0.9, mean_dreamy_sev + 0.2, 
            f'○ Doc Dreamy: {mean_dreamy_sev:.2f}', color='#4E79A7', 
...
# Professional styling
ax.set_xlabel('Initial Patient Severity', fontsize=11, fontweight='bold')
ax.set_ylabel('Post-Surgical Symptom Score (Lower is Better)', fontsize=11, fontweight='bold')
